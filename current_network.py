...
from input_data import csv_import, DataSet
...
# Define weights
weights = {
    'out': tf.compat.v1.Variable(tf.random.normal([n_hidden, n_classes]))
}
biases = {
...
def RNN(x, weights, biases):
    ...
    lstm_cell = tf.compat.v1.nn.rnn_cell.LSTMCell(n_hidden, forget_bias=1.0)
